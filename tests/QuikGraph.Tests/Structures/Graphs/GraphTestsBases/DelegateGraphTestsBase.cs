...
namespace QuikGraph.Tests.Structures
{
    ...
    internal class DelegateGraphTestsBase : GraphTestsBase
    {
            ...
            [NotNull] IImplicitGraph<int, Edge<int>> graph)
        {
            ...
            data.ShouldReturnEdges = [Edge.Create(1, 2)];
            ...
            [NotNull] IBidirectionalIncidenceGraph<int, Edge<int>> graph)
        {
            ...
            data1.ShouldReturnEdges = [Edge.Create(1, 2)];
            data2.ShouldReturnEdges = null;
            Assert.AreEqual(1, graph.Degree(1));

            data1.ShouldReturnEdges = null;
            data2.ShouldReturnEdges = [Edge.Create(3, 1)];
            Assert.AreEqual(1, graph.Degree(1));

            data1.ShouldReturnEdges = [Edge.Create(1, 2), Edge.Create(1, 3)];
            data2.ShouldReturnEdges = [Edge.Create(4, 1)];
            Assert.AreEqual(3, graph.Degree(1));

            // Self edge
            data1.ShouldReturnEdges = [Edge.Create(1, 2), Edge.Create(1, 3), Edge.Create(1, 1)];
            data2.ShouldReturnEdges = [Edge.Create(4, 1), Edge.Create(1, 1)];
            ...
            [NotNull] IIncidenceGraph<int, Edge<int>> graph)
        {
            ...
            data.ShouldReturnEdges = [Edge.Create(1, 2), Edge.Create(1, 2)];
            ...
            [NotNull] IImplicitGraph<int, Edge<int>> graph)
        {
            ...
            data.ShouldReturnEdges = [Edge.Create(1, 4), Edge.Create(1, 2)];
            ...
            [NotNull] IBidirectionalIncidenceGraph<int, Edge<int>> graph)
        {
            ...
            data.ShouldReturnEdges = [Edge.Create(4, 1), Edge.Create(2, 1)];
