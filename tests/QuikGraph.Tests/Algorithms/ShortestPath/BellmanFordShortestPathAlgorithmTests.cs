...
namespace QuikGraph.Tests.Algorithms.ShortestPath
{
    ...
    internal sealed class BellmanFordShortestPathAlgorithmTests : RootedAlgorithmTestsBase
    {
        ...
        public void Constructor_Throws()
        {
            ...
            Assert.Throws<ArgumentNullException>(
                () => adjacencyGraph.CreateBellmanFordShortestPathAlgorithm(null));
            Assert.Throws<ArgumentNullException>(
            ...
            Assert.Throws<ArgumentNullException>(
                () => adjacencyGraph.CreateBellmanFordShortestPathAlgorithm(null, DistanceRelaxers.CriticalDistance));
            _ = adjacencyGraph.CreateBellmanFordShortestPathAlgorithm(Weights);
            Assert.Throws<ArgumentNullException>(
