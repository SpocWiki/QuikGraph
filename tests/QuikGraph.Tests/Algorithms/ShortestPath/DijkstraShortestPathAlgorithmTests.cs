...
namespace QuikGraph.Tests.Algorithms.ShortestPath
{
    ...
    internal sealed class DijkstraShortestPathAlgorithmTests : RootedAlgorithmTestsBase
    {
        ...
        public void Constructor_Throws()
        {
            ...
            _ = graph.CreateDijkstraShortestPathAlgorithm(Weights);
            Assert.Throws<ArgumentNullException>(
                () => graph.CreateDijkstraShortestPathAlgorithm(null));
            Assert.Throws<ArgumentNullException>(
                () => graph.CreateDijkstraShortestPathAlgorithm(null));

            _ = graph.CreateDijkstraShortestPathAlgorithm(Weights, DistanceRelaxers.CriticalDistance);
            Assert.Throws<ArgumentNullException>(
                () => graph.CreateDijkstraShortestPathAlgorithm(null, DistanceRelaxers.CriticalDistance));
            _ = graph.CreateDijkstraShortestPathAlgorithm(Weights);
            Assert.Throws<ArgumentNullException>(
                () => graph.CreateDijkstraShortestPathAlgorithm(null, DistanceRelaxers.CriticalDistance));
            _ = graph.CreateDijkstraShortestPathAlgorithm(Weights);
        ...
        public void DijkstraSimpleGraph()
        {
            ...
            var predecessorObserver = algorithm.AttachVertexPredecessorRecorderObserver();
            using (predecessorObserver)
        ...
        public void Scenario()
        {
            Assert.DoesNotThrow(() =>
            {
                ...
                // Attach a Vertex Predecessor Recorder Observer to give us the paths
                var predecessorObserver = dijkstra.AttachVertexPredecessorRecorderObserver();
                using (predecessorObserver)
                {
