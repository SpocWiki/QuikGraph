...
{
    /// <inheritdoc cref="CreateMultiSourceSinkGraphAugmentorAlgorithm{TVertex,TEdge}"/>
    public static class MultiSourceSinkGraphAugmentorAlgorithm
    {
        /// <summary> Initializes a new instance of the <see cref="MultiSourceSinkGraphAugmentorAlgorithm{TVertex,TEdge}"/> class. </summary>
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        internal MultiSourceSinkGraphAugmentorAlgorithm([NotNull] IMutableBidirectionalGraph<TVertex, TEdge> visitedGraph,
            [NotNull] VertexFactory<TVertex> vertexFactory,
            [NotNull] EdgeFactory<TVertex, TEdge> edgeFactory, [CanBeNull] IAlgorithmComponent host = null)
