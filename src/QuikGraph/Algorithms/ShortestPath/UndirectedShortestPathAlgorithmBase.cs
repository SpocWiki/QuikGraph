...
namespace QuikGraph.Algorithms.ShortestPath
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="UndirectedShortestPathAlgorithmBase{TVertex,TEdge}"/> class. </summary>
        ...
        protected UndirectedShortestPathAlgorithmBase([NotNull] IUndirectedGraph<TVertex, TEdge> visitedGraph,
